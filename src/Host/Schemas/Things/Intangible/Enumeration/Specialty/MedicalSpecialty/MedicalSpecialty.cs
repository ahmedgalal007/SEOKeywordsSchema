using FSH.WebApi.Domain.Schemas.Things.Intangibles.Enumerations.MedicalEnumerations.MedicalSpecialties;
using System;
...
namespace FSH.WebApi.Domain.Schemas.Things.Intangibles.Enumerations.Specialties;
