...
namespace SEOKeywordsSchema.Schemas.Schema.Org.Entities.Intangible.Enumeration.DeliveryMethod.LockerDelivery;
public class LockerDelivery : DeliveryMethod
{
    public override string TypeName { get; protected set; } = nameof(LockerDelivery);
}
