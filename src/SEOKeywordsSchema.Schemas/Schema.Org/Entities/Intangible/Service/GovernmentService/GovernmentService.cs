...
namespace SEOKeywordsSchema.Schemas.Schema.Org.Entities.Intangible.Service.GovernmentService;
public class GovernmentService : Service
{
    public override string TypeName { get; protected set; } = nameof(GovernmentService);
}
