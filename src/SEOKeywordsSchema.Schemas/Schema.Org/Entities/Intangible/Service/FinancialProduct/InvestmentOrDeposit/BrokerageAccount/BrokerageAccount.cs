...
namespace SEOKeywordsSchema.Schemas.Schema.Org.Entities.Intangible.Service.FinancialProduct.InvestmentOrDeposit.BrokerageAccount;
public class BrokerageAccount : InvestmentOrDeposit
{
    public override string TypeName { get; protected set; } = nameof(BrokerageAccount);
}
