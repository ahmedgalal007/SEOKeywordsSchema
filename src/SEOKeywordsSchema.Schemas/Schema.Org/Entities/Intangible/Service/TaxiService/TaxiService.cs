...
namespace SEOKeywordsSchema.Schemas.Schema.Org.Entities.Intangible.Service.TaxiService;
public class TaxiService : Service
{
    public override string TypeName { get; protected set; } = nameof(TaxiService);
}
