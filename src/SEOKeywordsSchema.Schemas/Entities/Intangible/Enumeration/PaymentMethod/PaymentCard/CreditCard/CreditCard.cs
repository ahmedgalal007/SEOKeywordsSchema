using SEOKeywordsSchema.Schemas.Entities.Intangibles.Enumerations.PaymentMethods;
using System;
...
namespace SEOKeywordsSchema.Schemas.Entities.Intangibles.Enumerations.PaymentMethods.PaymentCards;
