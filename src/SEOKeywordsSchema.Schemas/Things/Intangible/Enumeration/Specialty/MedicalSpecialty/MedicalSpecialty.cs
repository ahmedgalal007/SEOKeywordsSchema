using SEOKeywordsSchema.Schemas.Things.Intangibles.Enumerations.MedicalEnumerations.MedicalSpecialties;
using System;
...
namespace SEOKeywordsSchema.Schemas.Things.Intangibles.Enumerations.Specialties;
